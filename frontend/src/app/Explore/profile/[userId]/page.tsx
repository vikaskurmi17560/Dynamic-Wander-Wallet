...
import SuggestedUsers from '@/app/profile/SuggestedUsers';
import ProfilePost from '@/app/profile/ProfilePost';
import ProfileReel from '@/app/profile/Reel/ProfileReel';
import ProfileTrip from '@/app/profile/Trip/ProfileTrip';
        ...
        <main className={style.main}>
            ...
            <section className={style.container_combine}>
                ...
                <div className={style.profile_post_data}>
                    {post && <ProfilePost userId={userId} isDisabled={true} />}
                    {videos && <ProfileReel userId={userId} />}
                    {others && <ProfileTrip isDisabled={true} userId={userId} />}
                </div>
            </section>
        </main>
    );
