  ...
  const News = [
    {
      ...
      date: "Dec 02, 2024",
      comment:
        "Wander-wallet is also carving a niche for itself in this space and intends to become a one-stop shop for personalised vacation",
    },
    {
      ...
      date: "Nov 21, 2024",
      comment:
        "With offbeat experiences and a platter-full of trending destinations, Wander-wallet is helping change the way people travel",
    },
    {
      companyname: "nasscom",
      link: "",
      ...
      date: "Sep 23, 2024",
      comment:
        "Tailor made to suit the needs of the travellers, Wander-wallet offers a much-needed respite from packaged tours",
    },
    {
      ...
      date: "Feb 10, 2025",
      comment:
        "Wander-wallet uses its unique matching algorithms and price comparison engine to help travellers create customised tour packages at competitive online prices.",
    },
    {
      ...
      date: "Jan 04, 2024",
      comment:
        "Wander-wallet has helped book international vacations for over 10,000 travelers since 2014",
    },
  ];
